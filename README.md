...
Want to discover APIs yourself? The **[`test-harness/`](test-harness/)** folder has a guide on crawling the game's API ([`test-harness/api-crawling.md`](test-harness/api-crawling.md)) and verified walkthroughs like querying the pause menu and exiting to the main menu programmatically.
